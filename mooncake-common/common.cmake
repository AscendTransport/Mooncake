...
if (USE_ASCEND)
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11 -fstack-protector-strong -fPIE -pie -s -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -Wl,--copy-dt-needed-entries -DOPEN_BUILD_PROJECT ")
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -std=c++11 -fstack-protector-strong -fPIE -pie -s -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -Wl,--copy-dt-needed-entries -DOPEN_BUILD_PROJECT ")
  add_compile_definitions(USE_ASCEND)
  include_directories(/usr/local/include /usr/include /usr/local/Ascend/ascend-toolkit/latest/aarch64-linux/include)
